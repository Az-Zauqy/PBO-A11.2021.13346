...
public class frmBackup extends javax.swing.JFrame {
    ...
    private void cmdOkeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdOkeActionPerformed
        String executeCmd;
 executeCmd = "C:/xampp/mysql/bin/mysqldump -uroot penjualan -r D:\\Kuliah\\Semester4\\PBO\\UAS_PBO\\JavaApplication1\\penjualan.sql"; //ganti sesuai dengan nama user & nama database mysql anda
 try {
