...
INSERT INTO `barang` VALUES ('0001','Mie','bungkus',2000,103,10,3000),('0002','Kaos','lembar',30000,91,10,50000),('0003','Tumbler','buah',120000,96,10,150000),('0004','mainan','buah',10000,50,1,8000),('0006','Le mineral','null',3000,53,5,5000),('0007','pure life','null',3000,105,5,5000);
...
INSERT INTO `beli` VALUES (1,'ks2','2023-07-08'),(2,'ks2','2023-07-08'),(8,'ks4','2023-07-14'),(10,'ks3','2023-07-14');
...
INSERT INTO `dbeli` VALUES (1,'0001',2000,20),(2,'0002',30000,5),(8,'0006',3000,10),(10,'0007',3000,10);
...
INSERT INTO `djual` VALUES (1,'0001',3000,7),(2,'0002',50000,2),(7,'0005',5000,10),(8,'0006',5000,7),(10,'0007',5000,5);
...
INSERT INTO `jual` VALUES (0,'k1','2023-07-12'),(1,'k1','2023-07-08'),(2,'k2','2023-07-08'),(7,'k4','2023-07-14'),(8,'k4','2023-07-14'),(10,'k1','2023-07-14');
...
INSERT INTO `konsumen` VALUES ('k1','budi','genuk','semarang','3456','0821456738','budi@gmail.com'),('k2','Rasyid','Semarang Indah','Semarang','2343','082189393741','rasyid@gmail.com'),('k3','Hemosa','Genuk','Solo','1234','085391409742','hermosa@gmail.com');
...
INSERT INTO `supplier` VALUES ('ks1','Handoko','Jl.Chakra Adwijaya','Jakarta','2003','082158763432','handoko@gmail.com'),('ks2','Faith Industries','Jl.Soekarno Hatta','Bandung','1234','082279319482','faith@gmail.com'),('ks3','purelifecommunity','jakarta raya','Jakarta','62783','0821638292','pure@gmail.com'),('ks4','PT.Mineral','genuk jaya','jakarta','552667','082346173978','mineral@gmail.com');
...
-- Dump completed on 2023-07-14 16:15:45
